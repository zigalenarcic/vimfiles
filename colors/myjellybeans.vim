...
if version >= 700
  ...
  hi Pmenu          guifg=#767Db1     guibg=#0d1020     gui=NONE      ctermfg=NONE        ctermbg=NONE        cterm=NONE
  hi PmenuSel       guifg=#0d1020       guibg=#767Db1     gui=NONE      ctermfg=NONE        ctermbg=NONE        cterm=NONE
  hi PmenuSbar      guifg=#262D51     guibg=#0d1020     gui=NONE      ctermfg=black       ctermbg=white       cterm=NONE
  hi PmenuThumb     guifg=#262D51     guibg=#262D51     gui=NONE      ctermfg=black       ctermbg=white       cterm=NONE
...
hi Comment guifg=#888888 gui=NONE ctermbg=none ctermfg=grey
hi Todo guifg=#808080 guibg=NONE gui=bold,italic

hi StatusLine guifg=#f0f0f0 guibg=#000000 gui=NONE
"guibg=#101010 gui=italic
hi StatusLineNC guifg=#a0a0a0 guibg=#000000 gui=NONE
"gui=italic
